const links = [
    {"include":"links-main",  "expires": "2024-06-13 10:30:00", name:"event",    text:"Sonar demo: Count-Me-In", link:"https://count-me-in.azurewebsites.net/sequencer?room=sonarintro", icon:""},
    {"include":"links-main",  "expires": "2024-06-13 10:30:00", name:"event",    text:"Sonar demo: DBASS", link:"https://dbass.link/sequencer?room=sonarintro", icon:""},
    ...
    {"include":"none",  "expires": "no", name:"facebook", text:"Facebook", link:"https://www.facebook.com/spacebarman", icon:""},
